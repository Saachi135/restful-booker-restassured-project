...
public class CrudTest {
    ...
    AuthorisationPojo authorisationPojo = new AuthorisationPojo();
        ...
        authorisationPojo.setPassword("pass123456");
    token = given()
    ...
    public void test02() {
        ...
        bookingPojo.setFirstname("Gaurang");
        bookingPojo.setLastname("Panchal");
    ...
    public void test04() {
        ...
        updateBookingPojo.setFirstname("Gaurang");
        updateBookingPojo.setLastname("Panchal");
